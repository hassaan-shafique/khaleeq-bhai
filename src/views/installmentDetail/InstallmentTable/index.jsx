...
const InstallmentTable = ({ loading, installments, saleStats, salesData }) => {
    ...
    const totalInstallmentAmount = useMemo(() => {
        return sortedInstallments.reduce((sum, inst) => sum + Number(inst.amount || 0), 0);
    }, [sortedInstallments]);
            ...
            <Card sx={{ marginBottom: 2, padding: 2, boxShadow: 3 }}>
                <CardContent>
                    <Typography variant="h6" fontWeight="bold" color="primary">
                        Total Installment Amount: Rs {totalInstallmentAmount.toLocaleString()}
                    </Typography>
                </CardContent>
            </Card>
