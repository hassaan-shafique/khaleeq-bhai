...
import { Container, Box, TextField, Button, Typography, Avatar, Grid, useMediaQuery, useTheme } from '@mui/material'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography component='h1' variant='h5' sx={{ mt: isSmallScreen ? 1 : 2 }}>
